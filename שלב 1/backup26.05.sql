...
prompt Created on יום ראשון 26 מאי 2024 by Hodaya
set feedback off
set define off
...
alter table DONOR disable constraint SYS_C007359;
prompt Disabling foreign key constraints for DONATION...
alter table DONATION disable constraint SYS_C007386;
alter table DONATION disable constraint SYS_C007387;
prompt Disabling foreign key constraints for EMPLOYEE...
alter table EMPLOYEE disable constraint SYS_C007367;
prompt Disabling foreign key constraints for EVENT...
alter table EVENT disable constraint SYS_C007354;
prompt Disabling foreign key constraints for PARTICIPATES...
alter table PARTICIPATES disable constraint SYS_C007371;
alter table PARTICIPATES disable constraint SYS_C007372;
prompt Disabling foreign key constraints for WORKSON...
alter table WORKSON disable constraint SYS_C007376;
alter table WORKSON disable constraint SYS_C007377;
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (625149514, 'Chantי', '6 Caviezel RoadPrinceton', 'chant.dillon@newmedia.com', '054-3965352', 'Dillon');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (615959839, 'Elle', '54 Redhill AveHהssleholm', 'ellef@mavericktechnologie', '050-8136355', 'Field');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (317635954, 'Millie', '35 Minnie RoadVisselhצvede', 'millie.margolyes@employer', '051-4235183', 'Margolyes');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (169179476, 'Lisa', '76 Cockburn DriveTהby', 'l.shocked@techbooks.se', '051-2319592', 'Shocked');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (596542332, 'Lisa', '62nd StreetThצrishaus', 'lisa.bacharach@visaintern', '054-5834441', 'Bacharach');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (695937844, 'Junior', '85 Duvall DriveThצrishaus', 'junior.rhymes@viacell.ch', '052-5783992', 'Rhymes');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (546289323, 'Eddie', '13 Garcia StreetWrzburg', 'eddie.tucci@formatech.de', '056-8223953', 'Tucci');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (342299945, 'Bill', '76 Lynn RoadKרbenhavn', 'bill.senior@gtp.dk', '056-9362568', 'Senior');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (417431712, 'Manu', '58 Stewart BlvdSדo paulo', 'manu.griggs@cmi.br', '054-6422165', 'Griggs');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (829814233, 'Nile', '766 Tהby StreetMacau', 'nile.cash@telwares.mo', '051-8257219', 'Cash');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (231424388, 'Sheena', '36 Cate StreetPaחo de Arcos', 'sheena.kutcher@infopros.p', '058-5692215', 'Kutcher');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
values (852412535, 'Rueben', '2 Jean-LucAniטres', 'rweston@mqsoftware.ch', '057-4247554', 'Weston');
insert into PERSON (personid, firstname, address, email, phonenumber, lastname)
...
insert into DONOR (registrationdate, eventid, personid)
values (to_date('29-04-2014', 'dd-mm-yyyy'), 68387, 231424388);
insert into DONOR (registrationdate, eventid, personid)
...
insert into DONATION (donationid, numofpayments, amount, donationdate, paymentmethod, campaignid, donorid)
values (362, 8, 528.15, to_date('20-12-2023', 'dd-mm-yyyy'), 'Credit Card', 1, 231424388);
insert into DONATION (donationid, numofpayments, amount, donationdate, paymentmethod, campaignid, donorid)
...
insert into EMPLOYEE (hourlywage, seniority, workhours, position, eventid, personid)
values (73, 4, 10, 'Secretary', 22277, 231424388);
insert into EMPLOYEE (hourlywage, seniority, workhours, position, eventid, personid)
...
alter table DONOR enable constraint SYS_C007359;
prompt Enabling foreign key constraints for DONATION...
alter table DONATION enable constraint SYS_C007386;
alter table DONATION enable constraint SYS_C007387;
prompt Enabling foreign key constraints for EMPLOYEE...
alter table EMPLOYEE enable constraint SYS_C007367;
prompt Enabling foreign key constraints for EVENT...
alter table EVENT enable constraint SYS_C007354;
prompt Enabling foreign key constraints for PARTICIPATES...
alter table PARTICIPATES enable constraint SYS_C007371;
alter table PARTICIPATES enable constraint SYS_C007372;
prompt Enabling foreign key constraints for WORKSON...
alter table WORKSON enable constraint SYS_C007376;
alter table WORKSON enable constraint SYS_C007377;
